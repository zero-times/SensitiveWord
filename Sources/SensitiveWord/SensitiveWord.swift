...
public class SensitiveWordFilter {
    ...
    public typealias FilterResult = (isContain: Bool, filteredText: String)
    ...
    public func filter(text: String, with replaceChar: String = "*") -> FilterResult {
        var filterdStr = text
        var isCotain = false
    ...
    private func getSentiveWords() -> [String] {
        ...
        guard let filePath = Bundle.init(for: SensitiveWordFilter.self).path(forResource: "SensitiveWords", ofType: nil) else {return [String]()}
